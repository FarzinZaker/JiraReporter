...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(13), __webpack_require__(43).setImmediate))
...
var sort_1 = __webpack_require__(50);
var dataproxy_1 = __webpack_require__(10);
...
var XMLDriver_1 = __webpack_require__(48);
exports.dataDrivers = {
...
var editors_1 = __webpack_require__(58);
        ...
        return dom_1.el(".dhx_grid-row", {
            ...
            if (!col.hidden) {
                ...
                if (typeof content === "string") {
                    // FIXME - we can use direct flag on a column to allow/deny HTML content inside of a cell
                    // QUESTION - do we really need the dhx_cell-content - it doesn't set for number cells anyway
                    content = dom_1.el("div.dhx_cell-content", content.indexOf("<") !== -1 ? { ".innerHTML": content } : content);
                }
                ...
                combo.events.on("change", function (id) {
                    if (id) {
                        ...
                        if (combo.data.getItem(id)) {
                            ...
                            value = item.value;
                            config.events.fire(types_1.GridEvents.headerInput, [value, colId, "comboFilter"]);
                        }
                        else {
                            config.events.fire(types_1.GridEvents.headerInput, ["", colId, "comboFilter"]);
                        }
                    }
                });
...
var core_1 = __webpack_require__(1);
var content_1 = __webpack_require__(37);
var columnsResizer_1 = __webpack_require__(87);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(13), __webpack_require__(45)))
...
Object.defineProperty(exports, "__esModule", { value: true });
var xml_1 = __webpack_require__(49);
...
var Selection = /** @class */ (function () {
    ...
    Selection.prototype._init = function () {
        ...
        this._grid.data.events.on(ts_data_1.DataEvents.beforeRemove, function (item) {
            if (item && _this._selectedCell.row) {
...
var FixedCols_1 = __webpack_require__(86);
var FixedRows_1 = __webpack_require__(36);
var core_1 = __webpack_require__(1);
var BORDERS = 2;
...
Object.defineProperty(exports, "__esModule", { value: true });
var types_1 = __webpack_require__(2);
var InputEditor_1 = __webpack_require__(59);
var SelectEditor_1 = __webpack_require__(60);
var DateEditor_1 = __webpack_require__(61);
var CheckboxEditor_1 = __webpack_require__(76);
var ComboboxEditor_1 = __webpack_require__(77);
var lastEditor = {
    cell: {
        row: null,
        col: null
...
var dom_1 = __webpack_require__(0);
var types_1 = __webpack_require__(2);
var ts_calendar_1 = __webpack_require__(62);
...
var events_1 = __webpack_require__(4);
var view_1 = __webpack_require__(5);
var ts_timepicker_1 = __webpack_require__(64);
var DateHelper_1 = __webpack_require__(74);
var DateFormatter_1 = __webpack_require__(16);
var helper_1 = __webpack_require__(75);
var en_1 = __webpack_require__(30);
...
var events_1 = __webpack_require__(4);
var view_1 = __webpack_require__(5);
var ts_layout_1 = __webpack_require__(25);
var ts_slider_1 = __webpack_require__(69);
var en_1 = __webpack_require__(72);
var helper_1 = __webpack_require__(73);
...
var view_1 = __webpack_require__(5);
var types_1 = __webpack_require__(11);
var helpers_1 = __webpack_require__(68);
var events_1 = __webpack_require__(4);
...
var dom_1 = __webpack_require__(0);
var events_1 = __webpack_require__(4);
var Keymanager_1 = __webpack_require__(26);
var view_1 = __webpack_require__(5);
var ts_popup_1 = __webpack_require__(15);
...
var ComboboxEditor = /** @class */ (function () {
    ...
    ComboboxEditor.prototype.endEdit = function () {
    ...
    ComboboxEditor.prototype.toHTML = function () {
        var content = this._cell.col.options.map(function (item, i) {
...
var events_1 = __webpack_require__(4);
var html_1 = __webpack_require__(3);
var keycodes_1 = __webpack_require__(79);
var view_1 = __webpack_require__(5);
var ts_data_1 = __webpack_require__(6);
var ts_layout_1 = __webpack_require__(25);
var ts_list_1 = __webpack_require__(80);
var ts_popup_1 = __webpack_require__(15);
var keyListener_1 = __webpack_require__(84);
        ...
        if (this.config.multiselection) {
            ...
            if (selected) {
                if (this.config.selectAllButton && !this._state.unselectActive && this.data.getLength() === this.list.selection.getId().length) {
                    this._layout.cell("select-unselect-all").attach(helper_1.unselectAllView);
                    this._state.unselectActive = true;
                }
            }
            else {
                if (this.config.selectAllButton && this._state.unselectActive) {
                    this._layout.cell("select-unselect-all").attach(helper_1.selectAllView);
